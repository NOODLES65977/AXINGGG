...
-- 在 p.UIElements.Main 的创建部分，修正颜色流动效果
...
local UIStroke = e("UIStroke", {
    ...
    e("UIGradient", {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)), -- 白色
            ColorSequenceKeypoint.new(0.5, Color3.new(0, 0.7, 1)), -- 蓝色
...
local K=w and""..p.ToggleKey.Name..""or"点击按钮重新打开窗口"
